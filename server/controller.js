module.exports={
    ...
    getEvents:async(req,res)=>{
        ...
        // if(group==='date'){
        //    let dateEvents = events.map(async event=>{
        //         let id = event.id
        //         await db.Events.groups.get_date({id,group:true})
        //     })
        // } else if(group==='family'){
        //     events.map(async event=>{
        //         let id = event.id
        //         return await db.Events.groups.get_family({id,group:true})
        //     })
        // } else if(group==='friends'){
        //     events.map(async event=>{
        //         let id = event.id
        //         return await db.Events.groups.get_friends({id,group:true})
        //     })
        // } else if(group==='large'){
        //     events.map(async event=>{
        //         let id = event.id
        //         return await db.Events.groups.get_large({id,group:true})
        //     })
        // } 
